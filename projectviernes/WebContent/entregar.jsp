...
<html>
  <head>
    ...
    <title>Busque un trayecto</title>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <div class="row h-100">
          <div class="col-12 my-auto">
            <div class="masthead-content text-white py-5 py-md-0">
              <h1 class="mb-3">Bienvenidos a 'Te Lo Llevo'</h1>
              <p class="mb-5">Empresa líder en paquetería, tu decides si quieres ser transportista o enviar un paquete
  ...
  <form action="entregar" method="post">
    ...
    <input id="origin-input" class="form-control" type="text"
        placeholder="Introduzca el origen" name="entrega">
